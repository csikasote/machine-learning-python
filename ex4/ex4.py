...
def main():
    ...
    print('\nNeural Network parameters loaded successfully ...\n')
    ...
    input("\nPress <ENTER> to visualize hidden layer ...")
    visualize_hidden_layer(hidden_W1)
    save_fig("HIDDEN_LAYER")
